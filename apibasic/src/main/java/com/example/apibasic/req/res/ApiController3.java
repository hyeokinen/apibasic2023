package com.example.apibasic.req.res;
...
public class ApiController3 {
    ...
    @GetMapping("/employees")
     public List<Employee>  employeeList() {
        return List.of(
                new Employee("홍길동", "영업부", LocalDate.of(2019,12,1))
                ,new Employee("김철수", "구매부", LocalDate.of(2022,1,1))
                ,new Employee("안유미", "개발부", LocalDate.of(2016,2,1))
        );
     }
    ...
    public ResponseEntity<?> res4(String nick) {
        ...
        headers.set("say-anything", "party");
